...
$qeury= "SELECT id,name FROM events";
...
<body>
  ...
  <table class="overview">
    <tr>
      <th colspan="3">Event</th>  <th></th>
      <th>Update</th>
      <th>Delete</th>
      <th>Add participacte</th>
    </tr>
<?php
while($row=$result->fetch_assoc()){
      echo "<tr>";
      echo '<td colspan="3"><a href="details.php?para=' . $row["id"] . '">'.$row["name"]."</a></td>";
      echo "<td></td>";
      ...
      echo '<td><a href="addpart.php?para=' . $row["id"] . '">'." <i class=\"fas fa-user-plus\"></i> </a>&nbsp; &nbsp;";
      // echo "<a href= \"partlist.php?para='".$row['id']."'\"><i class=\"fas fa-users\"></i> </a>";
      echo "</td>";
      echo "</tr>";
